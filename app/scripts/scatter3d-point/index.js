...
Scatter3D.markerSymbols = require('plotly.js/src/constants/gl3d_markers');
Scatter3D.supplyDefaults = require('./defaults');
Scatter3D.colorbar = require('plotly.js/src/traces/scatter/marker_colorbar');
Scatter3D.calc = require('./calc');

Scatter3D.moduleType = 'trace';
Scatter3D.name = 'scatter3d-point';
Scatter3D.basePlotModule = require('plotly.js/src/plots/gl3d');
Scatter3D.categories = ['gl3d', 'symbols', 'showLegend'];
Scatter3D.meta = {
    hrName: 'scatter_3d_point',
    description: [
